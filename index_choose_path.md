<div class="choose-path-container">
    <div class="row">
    <p><i><b>Note</b>: The documentation on this site is about Operations for Applications, formerly known as Tanzu Observability by Wavefront. We're in the process of updating the product name, but in many places we still refer to it as Tanzu Observability or Wavefront.</i></p>
    </div>
