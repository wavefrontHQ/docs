<div class="choose-path-container">
    <div class="row">
    <p><i><b>Note</b>: The documentation on this site is about Tanzu Observability, formerly known as Operations for Applications. We're in the process of updating the product name, but in many places we still refer to it as Operations for Applications or Wavefront.</i></p>
    </div>
