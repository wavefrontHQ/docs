...
1. Run the interactive configuration script: `bin/autoconf-wavefront-proxy.sh`. The script prompts you for the following properties:
   ...
   - **enable graphite** - Indicate whether to enable the Graphite format. See the Graphite [integration](/integration/graphite) for details on Graphite configuration.
...
1. [Verify that the proxy has registered](/proxies) with the Wavefront server.
