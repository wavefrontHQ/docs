...
summary: Learn about the Wavefront Operations for Applications Tutorial Integration.
---
## Tutorial Integration

The Tutorial integration is set of getting started dashboards to help new users learn how to use [[applicationName]]. They include:
