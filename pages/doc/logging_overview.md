...
* When you click **Go to Logs** from the alert, you see the log data from 6.08 AM to 6.10 AM. These logs help you identify the root cause that made the alert fire.
...
If you notice that a service on the application map, table view, or grid view has a high error percentage, you can drill down into logs from the application map:
* **Start with the Application Map View**
