...
<tr>
    ...
    {% include important.html content= "If you are on the VMware Cloud Services Subscription, the limits on the number of tags and the length of the tag key and value do not apply to you. For more detail on the subscriptions, see [Announcements](wavefront_release_notes.html#announcement)."%}
    </td>
  </tr>
</table>
