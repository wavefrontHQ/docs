...
In the metric name, specify:
* The wildcard  `*` in the `alertID` field 
* The alert name using the `alertName` keyword 
...
In the metric name, specify: 
* The alert ID in the `alertID` field. 

You can find the alert ID by viewing the alert in the Alerts browser (click the **Alerts** button). If you are editing the alert, you can find its ID in the page URL. 
