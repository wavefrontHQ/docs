...
{% include important.html content="Ingestion policies *do not* support metrics from external services, such as the Amazon Web Services, Google Cloud Platform, Microsoft Azure, Snowflake, VMware vRealize Operations Cloud, New Relic, Datadog, and Appdynamics integrations."%}
