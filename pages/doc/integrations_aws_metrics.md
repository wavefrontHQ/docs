...
- **Register [CloudWatch \| CloudTrail \| AWS Metrics+]** - Integrate each type of data individually. Choose this option if:
    ...
    - You can manually deploy AWS dashboards.  To get the dashboards, download the dashboards from the [AWS dashboard repository](https://github.com/wavefrontHQ/integrations/tree/master/aws/dashboards) and deploy them following the process in [Deploying a Dashboard](dashboards_managing.html#deploying-a-dashboard).
