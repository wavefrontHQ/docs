...
1. Click **Add Amazon Integration**.
...
1. Click the **Setup** tab.
1. Click the **Advanced** link.
1. In the row containing the integration you want to enable or disable, select ![action_menu.png](images/action_menu.png#inline) **> \[Enable \| Disable\]**.
