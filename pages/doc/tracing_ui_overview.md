      ...
      <br/>Click on the styling service. Now, you can:
        <ul>
          ...
          <ul>
            ...
            <li>If an alert you created fired, you see a red dot with a number on the service. The number indicates how many alerts are firing or fired for a specific service. To see the alerts, click <b>view alerts</b>.</li>
