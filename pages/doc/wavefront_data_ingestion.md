...
For data from Amazon Web Services (AWS), Wavefront supports cloud integrations. These allow you to pull data directly into Wavefront. Cloud integrations currently support AWS CloudWatch, CloudTrail, and AWS Metrics+ data. For more details, see [AWS Metrics Integration](integrations_aws_metrics.html).
