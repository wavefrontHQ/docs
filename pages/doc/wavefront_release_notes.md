...
With this release, we launch the Initial of Availability of our **Logs (Beta)** feature.
...
* You can use the **Linux Host** and **Wavefront Usage** integrations that we improved for logs. See the updated [Integration Release Notes for October](integrations_new_changed.html#october-2022) for details.
