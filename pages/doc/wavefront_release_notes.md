...
* **Alert Clone Opens in Edit Mode**: When you clone an alert, the clone automatically opens in edit mode so that you can easily make the necessary changes. For details, see [Clone an Alert](alerts.html#clone-an-alert) and [Editing and Cloning the Integration Alerts](integrations.html#editing-and-cloning-the-integration-alerts).
