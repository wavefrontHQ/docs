...
* **New Functions**: We add the [`retainDimension` and `removeDimension` functions](ts_retainDimension_removeDimension.html) that allow you to keep or remove dimensions (point tags) from the results of your queries.
