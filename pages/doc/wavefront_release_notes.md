...
* **Wavefront Proxy**: We recently released Wavefront Proxy version 11. Go to the [Wavefront Proxy Release Notes](https://github.com/wavefrontHQ/wavefront-proxy/releases) on Github for details.

* **Wavefront Service**: In release 2022-11.x, we made the following improvements to the documentation and the Wavefront service:
