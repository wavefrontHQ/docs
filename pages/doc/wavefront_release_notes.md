...
* **Updates for Customers with Service Accounts in the Everyone Group**: The service accounts that were still part of the predefined **Everyone** group are now removed from this group. There's no impact on any existing functionality and integrations.
