...
* **Create and Manage Alerts Revamp**: Streamlined experience that improves usability and gives alert creators more options.
  ...
  See the [FAQ for the New Alert GUI](alerts_v2_faq.html), watch the [Create Alert Video](https://vmwaretv.vmware.com/media/t/1_e655iog1), or look at the new [Create Alert Tutorial](alerts_manage.html#create-alert-tutorial).
