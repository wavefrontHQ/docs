...
<table>
    <tbody>
        <tr>
            ...
            <ul>
            <li>When the Super Admin mode is <strong>enabled</strong>, you have full administrative privileges for the Tanzu Observability service. See the <a href="csp_users_roles.html#tanzu-observability-service-roles-built-in">Super Admin service role</a> for details.</li>
