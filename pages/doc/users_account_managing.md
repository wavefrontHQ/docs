...
- The dashboard that displays after you log in or when you click the Wavefront logo. The default setting is the [Tutorial: Introduction dashboard](documentation_getting_started.html#tutorial-dashboards).
