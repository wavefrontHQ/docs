...
- **[API Tokens](users_account_managing.html#generate-an-api-token)**
    ...
    Users with the **API Tokens** permission can [generate API tokens](users_account_managing.html#generate-an-api-token) for their user account. Service accounts *cannot* have this permission, because only a Wavefront administrator can generate API tokens for service accounts.
