...
1. In the Operations for Applications UI, generate an API token (discussed below).
...
1. Log in to your cluster (`<instance_name>.wavefront.com`, for example, `company1.wavefront.com`), as a user with the **Accounts** permission.
...
Here's a screenshot of the Edit Service Account screen inside the Operations for Applications GUI.
