...
The [Create Metrics from Logs for Real-Time Cloud Application Monitoring](https://www.wavefront.com/creating-metrics-logs/) blog post discusses a real example and complements this page. 
