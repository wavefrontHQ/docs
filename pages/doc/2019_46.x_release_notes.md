...
From this release onwards, you can directly navigate to tracing information from the service metric dashboard. See [Navigate to the Tracing UI from the Service Metrics Dashboard](tracing_ui_overview#navigate-to-the-tracing-ui-from-the-service-metrics-dashboard).
