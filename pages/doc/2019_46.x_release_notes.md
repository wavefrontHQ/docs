...
From this release onwards, you can directly navigate to tracing information from the service dashboard. See [Navigate to the Tracing Browser from the Service Dashboard](tracing_ui_overview.html#navigate-to-the-tracing-browser-from-the-service-dashboard).
