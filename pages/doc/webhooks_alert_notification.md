...
This page provides general steps for creating and managing a custom alert target. [Customizing Alert Target Templates](alert_target_customizing.html) provides further details about customizing the contents of alert notifications.

* **Note** As a convenience, you can follow the steps in [PagerDuty Integration](pagerduty.html), [VictorOps Integration](victorops.html), [Slack Integration](slack.html), or [HipChat Integration](hipchat.html) to configure custom alert targets specifically for these messaging platforms. (You can check for additional integrations [here](label_integrations.html).)
...
* For type **Webhook**, set these properties:
      ...
      <td markdown="span">REST endpoint of the messaging platform to receive the alert notification. Follow the setup steps in [Slack Integration](slack.html), [VictorOps Integration](victorops.html), or [HipChat Integration](hipchat.html) to obtain the notification URL. The notification URL must be publicly accessible. </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td markdown="span">Template describing the content of the alert notification. Click **Template** and select the template that corresponds your messaging platform: **Slack**, **VictorOps**, or **HipChat**.</td>
      </tr>
      </tbody>
      </table>
* For type **Email**, set these properties:
      ...
      <tr>
        <td><strong>Body Template</strong> </td>
        <td markdown="span">Template describing the content of the alert notification. Click **Template** and select the **HTML Email Default** template.</td>
      </tr>
      </tbody>
      </table>
* For type **PagerDuty**, set these properties:
      ...
      <tr>
        <td><strong>Body Template</strong> </td>
        <td markdown="span">Template describing the content of the alert notification. Click **Template** and select the **PagerDuty Default** template.</td>
      </tr>
      </tbody>
      </table>
