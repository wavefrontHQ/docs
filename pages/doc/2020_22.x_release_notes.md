...
{% include note.html content="[Tracing](tracing_basics.html) and [Histograms](proxies_histograms.html) are available by default for all customers starting with this release. Try them out and contact [support@wavefront.com](mailto:support@wavefront.com) if you want to use these features." %}
...
Troubleshoot anomalies on your metrics charts and drill down to view the logs that caused the issues. See [Managing External Logs](log_integration.html) for details.
![log integration](images/log_integration_intro.png)
