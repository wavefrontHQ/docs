...
Starting with this release, newly created alert notifications include a link to the new [Alert Viewer](alerts.html#examine-an-alert-in-alert-viewer). Existing notifications continue to link to the Alert chart, but you can edit those notifications to also (or exclusively) link to the Alert Viewer.
