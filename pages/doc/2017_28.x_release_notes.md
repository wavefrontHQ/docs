...
The "Getting Started" wizard is for new Wavefront instances and new users within existing instances. The wizard gives a overview of Wavefront architecture, a preview of dashboards and alerts, and next steps. If you are a trial user, the wizard leads you through the process of setting up your first integration.
