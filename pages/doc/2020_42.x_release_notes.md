...
* Use [`apdex()`](traces_function.html#apdex-function) to query the apdex score for your services, create charts, and create alerts.
* Use [`apdexLatency()`](traces_function.html#apdexlatency-functions) to query the satisfied threshold (T) and toleration threshold (4T) of a service.
