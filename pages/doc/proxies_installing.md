...
If a proxy doesn't start or [register with Wavefront](proxies_managing.html#viewing-registered-proxies) and you need help, contact [Support]({{site.support_link}}). Consider checking [Proxy Troubleshooting](proxies_installing.html#troubleshooting) 
