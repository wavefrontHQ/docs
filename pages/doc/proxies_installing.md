...
1. Click **Done**. The Proxies page displays. Verify that your proxy is listed. If not, follow the steps in [Managing Proxy Service Status](#managing-proxy-service-status) to make sure the proxy is running.
