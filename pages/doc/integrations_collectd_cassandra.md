...
summary: Learn how to send Cassandra data collected by collectd to Wavefront.
---
...
Wavefront supports an in-product integration that gets data from Cassandra using Telegraf. If you want to use collectd instead, follow the instructions on this page. 
