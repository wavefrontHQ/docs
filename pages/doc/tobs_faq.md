...
* **PPS**, or Points per Second means data points ingested per second to the Wavefront service. All customers are billed based on their PPS.
...
Yes!
* The [Hello Wavefront!](hello_wavefront_aws_tutorial.html) tutorial has:
