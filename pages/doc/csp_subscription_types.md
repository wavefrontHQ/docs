...
* **VMware Tanzu Insights Integration**: If your VMware Cloud organization is running both services, Operations for Applications and Insights, there's a bidirectional link between the two services. Operations for Applications sends alerts data to Insights, and Insights sends related insights to Operations for Applications. The Operations for Applications user interface shows the insights that are related to each alert. From within the Operations for Applications user interface, you can directly open a related insight in VMware Tanzu Hub and inspect the complete list of alerts and events associated with that insight.
