...
---
The following videos show how to use tags and searches in the GUI to find what you need. Clement's video explains how to use tagging in VMware Aria Operations for Applications (formerly known as Tanzu Observability by Wavefront). Note that in most of the videos we still refer to VMware Aria Operations for Applications as Tanzu Observability or Wavefront.
