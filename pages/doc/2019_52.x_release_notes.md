...
We've solved this problem by [offering configuration of NGNIX on an Ubuntu Linux VM](large_screen_display.html) that runs inside the customer network.
...
## Create Tracing Dasbhoards from a Template

<table style="width: 100%;">
<tbody>
<tr>
<td width="40%">
<p>You can now create your own tracing dashboard from our template and customize it. All charts in the current tracing dashboard are included in the template. You can add, remove, and customize charts, then save your tracing dashboard. See <a href="ui_dashboards.html#create-a-dashboard-from-a-tracing-template">Create a Dashboard from a Tracing Template</a> for details.<br>
