...
```
Returns the sum of the time series described by the expression. 
...
You can use [`rawsum()`](ts_rawsum.html) to avoid interpolation.  See [Standard Versus Raw Aggregation Functions](query_language_aggregate_functions.html).
