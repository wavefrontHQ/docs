...
With the 2023-XX release, we introduce ephemeral metrics, which have a short [retention period](terms_of_service.html#data-retention). **Super Admin** users can [convert](metrics_managing.html#convert-metrics-to-ephemeral-or-persistent) persistent metrics to ephemeral metrics and the reverse.
