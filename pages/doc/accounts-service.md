...
As a user with the **Accounts** permission, you [generate and revoke](wavefront_api.html#managing-api-tokens), if needed, authentication tokens for the service account. It’s also possible to deactivate a service account completely. 
