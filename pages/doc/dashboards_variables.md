...
2.  Click the <span class="fa-edit fa"/> icon to the right of the variable. The Query Parameters dialog displays:
    ...
    ![simple var with non-editor hide.png](images/simple_var_with_non-editor_hide.png)
...
![list var with non-editor hide.png](images/list_var_with_non-editor_hide.png)
...
![list var with non-editor hide and parameters.png](images/list_var_with_non-editor_hide_and_parameters.png)
...
![Image 20.png](images/Image_20.png)
...
![Image 21.png](images/Image_21.png)
