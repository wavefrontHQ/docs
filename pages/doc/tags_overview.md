...
<td>alert tag</td>
<td markdown="span">
[Organize related alerts](alerts.html#organizing-related-alerts). <br> Suppress tagged alerts during a [maintenance window](maintenance_windows_managing.html#creating-a-maintenance-window).</td>
