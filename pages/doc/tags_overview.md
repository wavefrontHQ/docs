...
* **[Span tags](trace_data_details.html#span-tags)** -- Special tags that are associated with a span. Certain span tags are required for a span to be valid. An application can be instrumented to include custom span tags, as well.
