...
1. The Getting Started Dashboards all use sample metrics. You can explore any metrics in Wavefront, including the **~sample.** metrics, using the Metrics browser:
    ...
    1. Optionally, explore folders until you see a bar chart icon <i class="fa fa-bar-chart"/> representing a metric.  In the next section you learn  how to create your own charts for metrics.
