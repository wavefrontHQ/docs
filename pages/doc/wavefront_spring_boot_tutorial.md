...
* You cannot save changes that you make to the preconfigured Spring Boot Inventory and Wavefront for Spring Boot Service Dashboards. If you want custom dashboards, you can clone and edit the dashboard. For details, see [Create and Customize Dashboards](ui_dashboards.html).
