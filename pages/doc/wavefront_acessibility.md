...
<td>Perform the action the element is meant to do. For example, if the element is a button, pressing <strong>Enter</strong> is the same as clicking the button. <p> Pressing Enter in the Query Editor, enters edit mode, so that you can type a new query or edit the existing one.</td>
</tr>
<tr>
