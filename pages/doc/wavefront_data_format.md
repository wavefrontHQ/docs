...
<ul>
<li><strong>Key</strong> - Tag keys must be a number, start with a letter or asterisk, or be quoted. For example, a tag key that starts with an underscore character must be enclosed in double quotes ("_MyKey").</li>
