...
See the [Wavefront proxy 9.0 release notes](https://github.com/wavefrontHQ/wavefront-proxy/releases/tag/wavefront-9.0) for details. 

* New [proxy configurations](proxies_configuring.html) to support:
  * Protobuf format via gRPC for the Jaeger integration.
  * Configure the application and service name so that RED metrics are reported with these tags. 
