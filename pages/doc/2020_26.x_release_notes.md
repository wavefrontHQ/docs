...
## Prometheus Support (Beta)

{% include note.html content="Prometheus Support Beta is available on demand. Contact customer support to discuss having it enabled. " %}
...
Events can make your charts look cluttered. You can control how you see events on the charts using the charts settings or the dashboard setting. See [Controlling Event Overlays](charts_events_displaying.html#controlling-event-overlays) for details.

### Save and Customize Charts in the Service dashboard

View queries used in the charts of the default service dashboard and save these charts to your dashboard. See [Save Charts in the Service Dashboard](tracing_ui_overview.html#save-charts-in-the-service-dashboard) for details.
