...
* A new top-level function, [`cs`](cs_function.html), supports for intuitive manipulation of delta counters. You can use the `cs` function with filters, function, etc. just like `ts()`.
