...
```
10-minute chart window + 13" screen = best probable resolution (e.g. ~1 second buckets)
1-week chart window + 27" screen = second best probable resolution (e.g. ~30 minute buckets)
1-week chart window + 13" screen = third best probable resolution (e.g. ~60 minute buckets)
```
