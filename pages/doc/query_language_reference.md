...
<tr>
<td>percentile(<strong>&lt;percentile&gt;</strong>, hs(<strong>&lt;hsMetric&gt;.&lt;hsTime&gt;</strong>))</td>
<td>Returns the specified histogram for the specified percentile, aggregated over a minute.</td>
</tr>
<tr>
<td>max(hs(<strong>&lt;hsMetric&gt;.&lt;hsTime&gt;</strong>) )</td>
<td>Returns the largest value in the specified histogram. </td>
</tr>
<tr>
<td>median(hs(<strong>&lt;hsMetric&gt;.&lt;hsTime&gt;</strong>))</td>
<td>Returns the median value in the specified histogram.</td>
</tr>
<tr>
<td>merge(hs(<strong>&lt;hsMetric&gt;.&lt;hsTime&gt;</strong>)&lbrack;,<strong>metrics|sources|sourceTags|pointTags|&lt;pointTagKey&gt;</strong>&rbrack;)</td>
