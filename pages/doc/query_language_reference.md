...
<td>Limits the number of time series returned by the query. <strong>numberOfTimeSeries</strong> specifies the number of time series that need to be returned. Optionally, use <strong>offsetNumber</strong> to specify the starting index of the values that need to be returned.</td>
</tr>
<tr>
