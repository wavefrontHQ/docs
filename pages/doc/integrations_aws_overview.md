...
1. Configure the integration properties:
     ...
     - **Service Limit Metrics** - Disable or enable the ingestion of support service limit metrics (also known as service quotas), that is, the metrics namespace `aws.limits.*`. You can later edit this setting, if necessary.
