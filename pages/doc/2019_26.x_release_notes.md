...
If your environment has been set up to offer the v2 Beta, you can easily switch from v2 Beta dashboards and charts to v1 dashboards and chart -- and switch back again.

<table style="width: 100%;">
<tbody>
<tr>
<td width="10%">
<strong>Step 1</strong></td>
<td width="90%">In you Wavefront instance, select your username from the gear icon.<br>  <img src="/images/select_UI_version.png" alt="select user preferences"></td></tr>
<tr>
<td width="10%">
<strong>Step 2</strong></td>
<td width="90%">Select the UI Version that you want to work in. <br><img src="/images/ui_version_menu.png" alt="select UI version"></td>
</tr>
</tbody>
</table>
