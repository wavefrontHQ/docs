...
{% include note.html content="A new filter will be introduced to the default service dashboard in [release 2020-26.x](2020.22.x_release_notes.html). As a result, you will not see RED metrics or see erroneous RED metrics on the default service dashboard. To avoid it, use the recommended Wavefront SDK and proxy versions. See [Troubleshooting](tracing_ui_overview.html#troubleshooting) for details."%}
